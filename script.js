document.getElementById('submit-name').addEventListener('click', function() {
  ...
  if (nameInput) {
    ...
    document.querySelector('.welcome').style.display = 'block'; // Tampilkan bagian welcome
    document.querySelector('.name-input-wrapper').style.display = 'none'; // Sembunyikan input nama
  } else {
